...
//
//  VSS $Header: /PIDevTools/Inc/PDIdev.h 13    7/22/03 2:10p Sgagnon $  
//
/////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////
#ifndef _PDIDEV_H_
...
public:
	...
	BOOL		SetSerialIF	( CPDIser * ); // Sets current serial port parameters locally: does not configure device
	VOID		GetSerialIF	( CPDIser * ); // Returns current serial port parameters locally: does not configure device
	...
	BOOL	GetBinary		( BOOL & );			// Gets device to binary output ( 'F' Command ) 
	BOOL	GetFrameRate	( ePiFrameRate & );	// Gets P&O Frame Rate ( 'R' Command )	BOOL	GetSourceFrame	( PDIori & );		// Gets Source Frame Rotation ( 'G' Command )
	...
	BOOL	GetSAlignment	( INT nSensor, PDI3vec & O, PDI3vec & X, PDI3vec & Y ); // Gets Alignment Reference Frame per sensor ( 'A' Command )
	...
	BOOL	SetSAlignment	( INT nSensor, const PDI3vec & O, const PDI3vec & X, const PDI3vec & Y ); // Sets Alignment Reference Frame per sensor ( 'A' Command )
	...
	VOID	Trace		( BOOL );	// Enables trace output to debug window (DEBUG build only)
	VOID	Log			( BOOL );	// Enables tracker I/O logging to file PICMDIF.LOG

	////////////////////////////////////
	// Pipe Export Methods
	////////////////////////////////////
	BOOL	StartPipeExport	( LPCTSTR szPipeName= (LPCTSTR) PDI_EXPORT_PIPE_NAME );	//Starts raw P&O export on named pipe
